...
public class SignUp extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            if (username.trim().isEmpty() || name.trim().isEmpty() || password.trim().isEmpty() || (user.equals("Customer") && meter.trim().isEmpty())) {
            ...
            try{
                ...
                if(user.equals("Admin")){
                    ...
                    str = "update login set user_name = '"+username+"', name = '"+name+"', password = '"+password+"', user = '"+user+"' where meter_no = '"+t4.getText()+"'";
                }
